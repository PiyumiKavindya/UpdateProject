...
import fixtures.entity.UserData;
import org.openqa.selenium.By;

import java.util.function.BiPredicate;

import static utils.PageActionsHelper.select;
...
public class AddUserComponent {
  ...
  public AddUserComponent setEmployeeNameTextBox(String employeeName) throws InterruptedException {
    waitAndSendKeys(EMPLOYEE_NAME_TEXT_BOX, employeeName);
    return this;
  }

  public AddUserComponent setUserNameTextBox(String userName) throws InterruptedException {
    waitAndSendKeys(USER_NAME_TEXT_BOX, userName);
    return this;
  }

  public AddUserComponent setPasswordTextBox(String password) throws InterruptedException {
    waitAndSendKeys(PASSWORD_TEXT_BOX, password);
    return this;
  }

  public AddUserComponent setConfirmPasswordTextBox(String password) throws InterruptedException {
